...
const services = [
  {
    ...
    description: "Professional home cleaning services tailored to your South Florida property needs. Regular maintenance cleaning for consistent home cleanliness.",
  ...
  },
  {
    ...
    description: "Professional turnover cleaning services for vacation rentals in South Florida. Fast, thorough, and guest-ready every time.",
    link: "/south-florida/airbnb-cleaning-services",
  },
  {
    icon: Sparkles,
    title: "Deep Cleaning",
    description: "Comprehensive deep cleaning for those hard-to-reach areas. Perfect for seasonal cleaning or special occasions in South Florida.",
    link: "/south-florida/deep-cleaning-services",
  },
];

export const SouthFloridaServicesSection = () => {
  return (
    <section className="py-20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Cleaning Services in South Florida</h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Professional cleaning solutions for every need across South Florida
          </p>
        </div>
