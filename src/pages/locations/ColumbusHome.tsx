...
const ColumbusHome = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t("locations.columbus.title", { defaultValue: "Columbus Ohio House Cleaning Services | Red Rock Cleaning" })}</title>
        <meta name="description" content={t("locations.columbus.description", { defaultValue: "Professional house and office cleaning in Columbus Ohio. Reliable service with easy online booking. Experience quality you can trust." })} />
      </Helmet>
      <Hreflang />
            ...
            <div className="container mx-auto px-4 text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button asChild size="lg" variant="cta">
                  <a href="/columbus-ohio-calculator">{t("cta.getQuote", { defaultValue: "Get a Quote" })}</a>
                </Button>
