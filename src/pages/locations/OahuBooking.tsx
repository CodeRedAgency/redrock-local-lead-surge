    ...
    jqueryScript.onload = () => {
      ...
      maidilyScript.onload = () => {
        if (window.MaidilyIframeSdk) {
          window.MaidilyIframeSdk.setup("397964c978ca16b871fc0044fe2f1f41");
        }
      };
    };
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-8">
              ...
              <p className="text-xl text-muted-foreground">
                {t('booking.subtitle', { region: 'Oahu' })}
              </p>
            </div>
            
            <div className="max-w-5xl mx-auto">
              <iframe 
                src="https://maidily.com/iframes/bookings/397964c978ca16b871fc0044fe2f1f41" 
                width="100%" 
                id="maidily-booking-iframe" 
                style={{ border: 0, minHeight: "800px" }}
                title="Oahu Cleaning Booking"
              />
            </div>
          </div>
        </main>
