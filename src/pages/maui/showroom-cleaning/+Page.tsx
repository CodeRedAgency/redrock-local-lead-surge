...
import { Diamond, Sparkles, Handshake, SprayCan, Square, Car, Sofa, Users, DollarSign, Search, MapPin, Calendar, Home, ShoppingBag, Utensils, Building2 } from "lucide-react";
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <Button asChild size="lg" variant="secondary" className="bg-background text-foreground hover:bg-background/90">
              <Link to="/book-now-maui">Get Your Free Showroom Cleaning Assessment</Link>
            </Button>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <img 
                ...
                alt="A pristine luxury car showroom on Maui after professional cleaning by Red Rock Cleans"
