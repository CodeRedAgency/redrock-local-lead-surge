...
import { HardHat, Box, Layers, Construction, Truck, User, Package, ShieldCheck, Timer, MapPin, Calendar, Home, Factory, Cog, HardDriveDownload } from "lucide-react";
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <Button asChild size="lg" variant="secondary" className="bg-background text-foreground hover:bg-background/90">
              <Link to="/book-now-maui">Get Your Free Warehouse Cleaning Assessment</Link>
            </Button>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <img 
                ...
                alt="A large, clean warehouse on Maui with polished floors, cleaned by Red Rock Cleans"
