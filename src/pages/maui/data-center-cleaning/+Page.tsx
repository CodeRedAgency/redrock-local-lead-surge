...
import { Cpu, Award, Clock, Grid3x3, Server, SprayCan, Database, TrendingUp, ShieldCheck, MapPin, Calendar, Home, Factory, Building, Stethoscope } from "lucide-react";
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <Button asChild size="lg" variant="secondary" className="bg-background text-foreground hover:bg-background/90">
              <Link to="/book-now-maui">Get Your Free Data Center Assessment</Link>
            </Button>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <img 
                ...
                alt="A pristine server room in a Maui data center after specialized cleaning by Red Rock Cleans"
