...
import { HeartHandshake, BookOpen, BadgeCheck, School, Footprints, Medal, Droplets, User, Building, Calendar, MapPin, Home, Building2, Stethoscope, Dumbbell } from "lucide-react";
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <Button asChild size="lg" variant="secondary" className="bg-background text-foreground hover:bg-background/90">
              <Link to="/book-now-maui">Get Your Free School Cleaning Assessment</Link>
            </Button>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <img 
                ...
                alt="A bright and sanitized classroom on Maui, cleaned by Red Rock Cleans"
