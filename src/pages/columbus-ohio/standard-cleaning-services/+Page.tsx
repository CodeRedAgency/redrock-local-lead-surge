...
const StandardCleaningColumbusOhioPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Standard Cleaning Service Columbus Ohio | Red Rock Cleans</title>
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="max-w-4xl mx-auto text-center">
                <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
                  Reliable Standard Cleaning Service in Columbus, Ohio
                </h1>
          ...
          <section className="py-16 bg-background">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                <img 
                  src="/src/assets/hero-residential.jpg" 
                  alt="A bright and tidy living room in a Columbus, Ohio home after a standard cleaning by Red Rock Cleans"
