...
import { Cpu, Award, Clock, Grid, Server, SprayCan, Database, TrendingUp, ShieldCheck, Building, Shield, Briefcase, Phone, Home } from "lucide-react";
...
const DataCenterCleaningColumbusOhioPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>{t(`commercialServices.columbus.dataCenter.title`, { defaultValue: "Data Center Cleaning in Columbus Ohio | Red Rock Cleans" })}</title>
        <meta name="description" content={t(`commercialServices.columbus.dataCenter.description`, { defaultValue: "Data center cleaning in Columbus Ohio. Protect critical infrastructure with specialized cleaning. Professional service!" })} />
      </Helmet>
