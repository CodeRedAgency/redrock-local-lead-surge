...
import { Microchip, Award, Clock, Database, Activity, Shield, HardHat, Server, Droplets, CheckCircle, Calendar, DollarSign, Users, Sparkles, Heart } from "lucide-react";
          ...
          <section className="py-16 bg-background">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                <img 
                  src="/src/assets/hero-commercial.jpg" 
                  alt="A pristine server room in an Oahu data center after specialized cleaning by Red Rock Cleans"
