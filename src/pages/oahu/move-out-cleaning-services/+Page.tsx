                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <ul className="space-y-3 text-muted-foreground">
                      ...
                      <li className="flex items-start">
                        <Sparkles className="w-4 h-4 text-primary mr-2 mt-1 flex-shrink-0" />
                        Clean windows, sills, and tracks (including salty residue)
                      </li>
                      <li className="flex items-start">
                        <Sparkles className="w-4 h-4 text-primary mr-2 mt-1 flex-shrink-0" />
          ...
          <section className="py-16 bg-background">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                <img 
                  src="/src/assets/service-products.jpg" 
                  alt="An empty, immaculate apartment in Honolulu ready for inspection after a move out cleaning by Red Rock Cleans"
