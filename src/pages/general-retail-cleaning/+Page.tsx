...
const RetailCleaningPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t("commercial.retail.title", { defaultValue: "Retail Store Cleaning Services | Red Rock Cleans" })}</title>
        <meta name="description" content={t("commercial.retail.description", { defaultValue: "Professional retail store cleaning services. Red Rock Cleans helps enhance your brand image and customer experience with spotless storefronts, sales floors, and more." })} />
      </Helmet>
      <Hreflang />
        ...
        <main className="flex-grow">
          ...
          <section className="relative h-[500px] flex items-center justify-center">
            ...
            <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
              <h1 className="text-5xl md:text-6xl font-bold mb-6">{t("commercial.retail.heading", { defaultValue: "Pristine Retail Cleaning to Elevate Your Brand" })}</h1>
              <p className="text-xl md:text-2xl mb-8">
                {t("commercial.retail.tagline", { defaultValue: "Transform your retail space into a spotless showcase that captivates customers and drives sales" })}
              </p>
          ...
          <section className="py-20 bg-muted/20">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="mb-16">
                  <h2 className="text-3xl font-bold mb-8 text-center">{t("commercial.retail.experience.title", { defaultValue: "Creating an Unforgettable Customer Experience" })}</h2>
                  <div className="grid md:grid-cols-3 gap-6">
                    <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer border-2 hover:border-primary/50">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="text-lg font-bold mb-3 group-hover:text-primary transition-colors">{t("commercial.retail.experience.i1.title", { defaultValue: "Immaculate First Impressions" })}</h3>
                    ...
                    <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer border-2 hover:border-primary/50">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="text-lg font-bold mb-3 group-hover:text-primary transition-colors">{t("commercial.retail.experience.i2.title", { defaultValue: "A Healthy Shopping Space" })}</h3>
                        <p className="text-sm text-muted-foreground">
                    ...
                    <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer border-2 hover:border-primary/50">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="text-lg font-bold mb-3 group-hover:text-primary transition-colors">{t("commercial.retail.experience.i3.title", { defaultValue: "Protecting Your Products" })}</h3>
                        <p className="text-sm text-muted-foreground">
                ...
                <div className="mb-16">
                  <h2 className="text-3xl font-bold mb-8 text-center">{t("commercial.retail.checklist.title", { defaultValue: "Our Comprehensive Retail Cleaning Checklist" })}</h2>
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer border-2 hover:border-primary/50">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="text-lg font-bold mb-3 group-hover:text-primary transition-colors">{t("commercial.retail.checklist.sales.title", { defaultValue: "Sales Floor & Displays" })}</h3>
                    ...
                    <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer border-2 hover:border-primary/50">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="text-lg font-bold mb-3 group-hover:text-primary transition-colors">{t("commercial.retail.checklist.fitting.title", { defaultValue: "Fitting Rooms & Restrooms" })}</h3>
                        <ul className="text-sm text-muted-foreground space-y-2 text-left">
                    ...
                    <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer border-2 hover:border-primary/50">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="text-lg font-bold mb-3 group-hover:text-primary transition-colors">{t("commercial.retail.checklist.windows.title", { defaultValue: "Windows & Storefront" })}</h3>
                        <ul className="text-sm text-muted-foreground space-y-2 text-left">
                    ...
                    <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer border-2 hover:border-primary/50">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="text-lg font-bold mb-3 group-hover:text-primary transition-colors">{t("commercial.retail.checklist.stock.title", { defaultValue: "Back-of-House & Stockrooms" })}</h3>
                        <ul className="text-sm text-muted-foreground space-y-2 text-left">
                ...
                <div className="bg-primary text-primary-foreground p-8 rounded-lg mb-12">
                  <h2 className="text-3xl font-bold mb-8 text-center">{t("commercial.retail.impact.title", { defaultValue: "The Impact of a Professionally Cleaned Store" })}</h2>
                ...
                <div className="bg-card p-8 rounded-lg shadow-lg mb-12">
                  <h2 className="text-3xl font-bold mb-6 text-primary">{t("commercial.retail.find.title", { defaultValue: "Find Retail Store Cleaning In Your Area" })}</h2>
                ...
                <div className="bg-muted/30 p-8 rounded-lg mb-12">
                  <h2 className="text-3xl font-bold mb-8 text-center">{t("commercial.retail.faq.title", { defaultValue: "Frequently Asked Questions" })}</h2>
                ...
                <div className="text-center py-12 bg-primary/5 rounded-lg shadow-inner">
                  <h2 className="text-4xl font-bold mb-6">{t("commercial.retail.cta.title", { defaultValue: "Ready to Elevate Your Retail Space?" })}</h2>
                  <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                    {t("commercial.retail.cta.copy", { defaultValue: "Choose your location to get a tailored quote for professional retail store cleaning services." })}
                  </p>
