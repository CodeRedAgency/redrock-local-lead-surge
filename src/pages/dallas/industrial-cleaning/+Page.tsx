...
import { Shield, Clock, Wrench, SprayCan, Construction, Layers, ShieldCheck, GanttChartSquare, Factory, Warehouse, Building2, Sparkles } from "lucide-react";
...
const IndustrialCleaningDallasPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Industrial Cleaning Services Dallas | Red Rock Cleans</title>
          ...
          <section className="py-16 bg-background">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                <img 
                  src="/src/assets/hero-commercial.jpg" 
                  alt="A heavy-duty industrial facility in Dallas after a thorough cleaning by Red Rock Cleans"
