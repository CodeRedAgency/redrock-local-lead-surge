...
const PostConstructionCleaningDallasPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Post Construction Cleaning Service Dallas | Red Rock Cleans</title>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                <img 
                  ...
                  alt="A pristine new home in Dallas after a professional post construction cleaning by Red Rock Cleans"
