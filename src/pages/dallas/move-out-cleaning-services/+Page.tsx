...
const MoveOutCleaningDallasPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Move Out Cleaning Service Dallas | Red Rock Cleans</title>
          ...
          <section className="py-16 bg-background">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                <img 
                  src="/src/assets/hero-residential.jpg" 
                  alt="An empty, immaculate apartment in Dallas ready for inspection after a move out cleaning by Red Rock Cleans"
