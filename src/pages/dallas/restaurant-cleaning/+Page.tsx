...
import { ClipboardCheck, Flame, Sparkles, DoorOpen, ChefHat, GlassWater, Droplets, Star, CheckCircle, Utensils, Store, Dumbbell, Package } from "lucide-react";
...
const RestaurantCleaningDallasPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Restaurant Cleaning Dallas | Red Rock Cleans</title>
          ...
          <section className="py-16 bg-background">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                <img 
                  src="/src/assets/hero-commercial.jpg" 
                  alt="An immaculate and empty upscale restaurant in Dallas, cleaned by Red Rock Cleans"
