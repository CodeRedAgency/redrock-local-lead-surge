  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional move-out cleaning in South Florida. Secure your deposit with thorough cleaning in Fort Lauderdale, Weston & Aventura. Book your service today!" />
      </Helmet>
      <Hreflang />
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
          ...
          <section className="relative py-24 md:py-32 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="max-w-4xl mx-auto text-center">
                <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">{t('southFlorida.moveout.h1')}</h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button size="lg" className="h-14 text-lg px-8" asChild>
                    <Link to="/book-now-south-florida">
                      ...
                      {t('southFlorida.moveout.schedule')}
                    </Link>
                  </Button>
                  <Button size="lg" variant="outline" className="h-14 text-lg px-8" asChild>
                    <Link to="/south-florida-calculator">
                      <Home className="w-5 h-5 mr-2" />
                      {t('southFlorida.moveout.quote')}
                    </Link>
                  </Button>
                </div>
              </div>
          ...
          <section className="py-20 bg-background">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">{t('southFlorida.moveout.checklistTitle')}</h2>
          ...
          <section className="py-20 bg-muted/30">
            <div className="container mx-auto px-4">
              <div className="max-w-6xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">{t('southFlorida.moveout.benefitsTitle')}</h2>
          ...
          <section className="py-20 bg-background">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">{t('southFlorida.moveout.areasTitle')}</h2>
          ...
          <section className="py-20 bg-muted/30">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold mb-8">{t('southFlorida.moveout.otherServicesTitle')}</h2>
          ...
          <section className="py-20 bg-background">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">{t('southFlorida.moveout.faqTitle')}</h2>
                <div className="space-y-6">
          ...
          <section className="py-20 bg-primary text-primary-foreground">
            <div className="container mx-auto px-4 text-center">
              <div className="max-w-3xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">{t('southFlorida.moveout.finalCtaTitle')}</h2>
